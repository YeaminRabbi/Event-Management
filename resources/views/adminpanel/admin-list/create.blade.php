...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Profile / </span> Admin</h4>    
    <div class="row">
        <!-- Basic Layout -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-phone"
                                    placeholder="017*******" name="phone" required />
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <input type="email" id="basic-default-email" class="form-control"
                                        ...
                                        aria-describedby="basic-default-email2"  name="email" required />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    placeholder="Input to change password" name="password" required/>                                    
                                </div>
                            </div>
                        </div>

                        {{-- //TODO in future this portion needs to be Dynamic - Admin Create --}}
                        <div class="row mb-3">
