...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="/AdminPanelAsset/vendor/css/core.css"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="/AdminPanelAsset/vendor/css/theme-default.css"
                ...
                <ul class="menu-inner py-1">
                    ...
                    @if (Auth::user()->hasRole('super-admin'))
                        <li class="menu-item">
                            <a href="{{ route('admin-list.index') }}" class="menu-link">
                                <i class="menu-icon tf-icons fa fa-user" aria-hidden="true"></i>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('payments.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons fa fa-credit-card-alt" aria-hidden="true"></i>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar">
                                        <img src="/logo/user-logo.jpg" alt
                                        ...
                                        <a class="dropdown-item" href="{{ route('profile') }}">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small style="color:blue;">{{ Auth::user()->getRoleNames()[0] }}</small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                        ...
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                ...
                                <a href="#" target="_blank"
                                    class="footer-link fw-bolder">TEAM</a>
                            </div>
